...
interface StudentData {
  ...
  Door_frame_and_shutter_shades_are_consistentt_Description: string;
  ...
  Floor_trap_below_cover_is_clean_: string;
...
@Component({
  selector: 'app-stoilet',
  templateUrl: './stoilet.page.html',
...
export class SToiletPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.ionicForm = this.formBuilder.group({
      ...
      Floor_trap_cover_is_provided_Photo: [''],
  ...
  getGallery1() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('UPVC_ventilators_are_operable_Photo').setValue(this.imgURL1);
      this.upload1();
    });
  }
  ...
  Save1(): void {
    ...
    //console.log('stoilet', JSON.stringify(this.stoilet));
  }
  sendMessage1(): void {
  ...
  getGallery7() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Hardware_is_as_per_standard_offering_Photo').setValue(this.imgURL7);
      this.upload7();
    });
  }
  ...
  getGallery10() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('All_sockets_or_switches_above_false_ceiling_are_functional_Photo').setValue(this.imgURL10);
      this.upload10();
    });
  }
  ...
  getGallery11() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Ceiling_electrical_points_are_covered_or_capped_properly_Photo').setValue(this.imgURL11);
      this.upload11();
    });
  }
  ...
  getGallery12() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Switch_plates_are_aligned_Photo').setValue(this.imgURL12);
      this.upload12();
    });
  }
  ...
  getGallery14() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Switches_are_operable_Photo').setValue(this.imgURL14);
      this.upload14();
    });
  }
  ...
  getGallery15() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('EWC_is_fixed_with_brackets_or_seat_covers_and_is_functional_Photo').setValue(this.imgURL15);
      this.upload15();
    });
  }
  ...
  getGallery17() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Shower_head_and_divertor_are_functional_Photo').setValue(this.imgURL17);
      this.upload17();
    });
  }
  ...
  getGallery18() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Floor_trap_cover_is_provided_Photo').setValue(this.imgURL18);
      this.upload18();
    });
  }
  ...
  Save18(): void {
    ...
    this.stoilet.push({
      id: Date.now(),
      user: this.au.email,
      inpect_title: 'Floor_trap_cover_is_provided',
      photourl: this.imgURL18,
      Description: this.ionicForm.get('Floor_trap_cover_is_provided_Description').value,
      timestamp: new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' })
    });
  ...
  sendMessage18(): void {
    this.newItem.user = this.au.email;
    this.newItem.inpect_title = 'Floor_trap_cover_is_provided';
    //this.newItem1.photourl = this.imgURL1;
    this.newItem.Description = this.ionicForm.get('Floor_trap_cover_is_provided_Description').value;
    this.newItem.timestamp = new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' });
    ...
    let email: any = {
      ...
      cc: 'sumathi@kraft-urspace.com',
      attachments: [],
      subject: 'Floor_trap_cover_is_provided',
      body: [JSON.stringify(this.newItem)],
      isHtml: true
    };
  ...
  getGallery19() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Floor_trap_cover_is_provided_and_is_free_of_debris_and_rust_Photo').setValue(this.imgURL19);
      this.upload19();
    });
  }
  ...
  Save30(): void {
    ...
    this.stoilet.push({
      id: Date.now(),
      user: this.au.email,
      inpect_title: 'Wash_Basin_in_mm',
      photourl: this.imgURL30,
      Description: this.ionicForm.get('Wash_Basin_in_mm_Description').value,
      timestamp: new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' })
    });
  ...
  sendMessage30(): void {
    this.newItem.user = this.au.email;
    this.newItem.inpect_title = 'Wash_Basin_in_mm';
    //this.newItem1.photourl = this.imgURL1;
    this.newItem.hight_in_mm = this.ionicForm.get('Wash_Basin_in_mm').value;
    this.newItem.Description = this.ionicForm.get('Wash_Basin_in_mm_Description').value;
    this.newItem.timestamp = new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' });
  ...
  getGallery32() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('WDado_top_line_is_uniform_and_consistent_Photo').setValue(this.imgURL32);
      this.upload32();
    });
  }
  ...
  submitForm(): void {
    ...
    this.AssetData = JSON.stringify(this.stoilet);
    this.DiningData = JSON.parse(this.AssetData);
    console.log('formdata collection', this.DiningData);

    washingtonRef
      .update({
        Servantroom_Toilet: arrayUnion({
          Servantroom_Toilet_Data: this.DiningData
        })
      })
      .then(function () {
  ...
  exportCSV() {
    this.storageService.setObject('socialdata', this.stoilet);

    var csv = this.papa.unparse(this.stoilet);
