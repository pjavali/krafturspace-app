...
this.cameradisplay20=false;
      ...
      Doors_and_Windows:['', [Validators.required]],
            ...
            Walls_and_ceiling:['', [Validators.required]],
               ...
               Cornices_provided_are_aligned:['', [Validators.required]],
                 Cornices_provided_are_aligned_Photo:[this.imgURL18, [Validators.required]],
               Cornices_provided_are_aligned_Description:['', [Validators.required]],

               Walls_are_free_of_cracks_or__stains_etc:['', [Validators.required]],
                Walls_are_free_of_cracks_or__stains_et_Photo:[this.imgURL19, [Validators.required]],
              Walls_are_free_of_cracks_or__stains_et_Description:['', [Validators.required]],

               Ceilings_are_free_of_stains_or_undulations_or_stains_etc:['', [Validators.required]],
                Ceilings_are_free_of_stains_or_undulations_or_stains_etc_Photo:[this.imgURL20, [Validators.required]],
              Ceilings_are_free_of_stains_or_undulations_or_stains_etc_Description:['', [Validators.required]]
 ...
 starttimeref.update({
  ...
  sendmail(){ 
    ...
    this.storageService.getObject('Servantroom form csv').then(result => {
    if (result != null) {
...
this.stdata=this.arrayToCSV(this.arr) ;
   this.storageService.setObject('Servantroom form csv', this.stdata);
...
washingtonRef.update({
  Dining:arrayUnion({
       "servantroom": this.DiningData
      
       
     })
}).then(function() {
  console.log("Servantroom form csv");
});
