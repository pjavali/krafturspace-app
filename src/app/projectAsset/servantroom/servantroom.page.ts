...
interface StudentData {
  ...
  Walls_are_free_of_cracks_or__stains_et_Photo: any;
  Walls_are_free_of_cracks_or__stains_et_Description: string;

  Ceilings_are_free_of_stains_or_undulations_or_stains_etc: string;
  Ceilings_are_free_of_stains_or_undulations_or_stains_etc_Photo: any;
  Ceilings_are_free_of_stains_or_undulations_or_stains_etc_Description: string;
}

@Component({
  selector: 'app-servantroom',
  templateUrl: './servantroom.page.html',
  styleUrls: ['./servantroom.page.scss']
})
export class ServantroomPage implements OnInit {
  //new
  completiontime: any;
  flist: any;
  flatnumber: any;
  ...
  ngOnInit() {
    ...
    this.ionicForm = this.formBuilder.group({
      ...
      UPVC_door_glass_is_free_of_scratches_Photo: [''],
      ...
      Ceiling_wall_electrical_points_are_covered_or_capped_properly: [''],
      Ceiling_wall_electrical_points_are_covered_or_capped_properly_Photo: [''],
      Ceiling_wall_electrical_points_are_covered_or_capped_properly_Description: [''],

      Flooring: [''],
      Transition_betweeen_wooden_flooring_and_toilet_at_entry: [''],
      Transition_betweeen_wooden_flooring_and_toilet_at_entry_Photo: [''],
      Transition_betweeen_wooden_flooring_and_toilet_at_entry_Description: [''],

      Vitrified_tile_flooring_is_consistent_and_free_of_hollowness: [''],
      Vitrified_tile_flooring_is_consistent_and_free_of_hollowness_Photo: [''],
      Vitrified_tile_flooring_is_consistent_and_free_of_hollowness_Description: [''],

      Skirting_finished_and_aligned: [''],
      Skirting_finished_and_aligned_Photo: [''],
      Skirting_finished_and_aligned_Description: [''],
      ...
      Walls_are_free_of_cracks_or__stains_et_Photo: [''],
      Walls_are_free_of_cracks_or__stains_et_Description: [''],

      Ceilings_are_free_of_stains_or_undulations_or_stains_etc: ['', [Validators.required]],
      Ceilings_are_free_of_stains_or_undulations_or_stains_etc_Photo: [''],
      Ceilings_are_free_of_stains_or_undulations_or_stains_etc_Description: ['']
    });
  }
  ...
  getGallery1() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('PVC_door_glass_is_free_of_scratches_Photo').setValue(this.imgURL1);
      this.upload1();
    });
  }
  ...
  Save1(): void {
    ...
    this.servantroomdata.push({
      ...
      inpect_title: 'PVC_door_glass_is_free_of_scratches',
      photourl: this.picdata,
      Description: this.ionicForm.get('PVC_door_glass_is_free_of_scratches_Description').value,
      timestamp: new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' })
    });

    console.log('servantroomdata', JSON.stringify(this.servantroomdata));
  }
  sendMessage1(): void {
    this.newItem.user = this.au.email;
    this.newItem.inpect_title = 'PVC_door_glass_is_free_of_scratches';
    //this.newItem1.photourl = this.imgURL1;
    this.newItem.Description = this.ionicForm.get('PVC_door_glass_is_free_of_scratches_Description').value;
    ...
    let email: any = {
      ...
      attachments: [],
      subject: 'PVC_door_glass_is_free_of_scratches',
  ...
  getGallery2() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Door_frame_and_shutter_gaps_are_consistent_Photo').setValue(this.imgURL2);
  ...
  getGallery3() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Lock_can_be_operated_from_both_sides_Photo').setValue(this.imgURL3);
      ///this.ionicForm[].Electrical_wall_and_ceiling_points_are_covered_Photo=this.imgURL1;
      // this.currentImage = this.imgURL1;
  ...
  getGallery4() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Door_frame_and_shutter_doesnot_have_dent_or_scratches_or_marks_Photo').setValue(this.imgURL4);
      this.upload4();
    });
  }
  ...
  getGallery5() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Door_frame_and_shutter_shades_are_consistent_Photo').setValue(this.imgURL5);
      this.upload5();
    });
  }
  ...
  getGallery7() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Door_stopper_is_operable_Photo').setValue(this.imgURL7);
      this.upload7();
    });
  }
  ...
  getGallery8() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Hardware_is_as_per_standard_offering_Photo').setValue(this.imgURL8);
      this.upload8();
    });
  }
  ...
  getGallery9() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('UPVC_hardware_is_as_per_standard()_Photo').setValue(this.imgURL9);
      this.upload9();
    });
  }
  ...
  getGallery11() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Electrical_points_are_as_per_standard_offering_Photo').setValue(this.imgURL11);
      this.upload11();
    });
  }
  ...
  getGallery13() {
    ...
    this.camera.getPicture(options).then(imageData => {
      this.picdata = imageData;
      this.imgURL12 = 'data:image/jpeg;base64,' + imageData;
      this.ionicForm.get('Wall_Light_points_are_covered__or_capped_properly_Photo').setValue(this.imgURL12);
      this.upload13();
    });
  }
  ...
  getGallery14() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Ceiling_wall_electrical_points_are_covered_or_capped_properly_Photo').setValue(this.imgURL14);
      this.upload14();
    });
  }
  ...
  Save14(): void {
    ...
    this.servantroomdata.push({
      id: Date.now(),
      user: this.au.email,
      inpect_title: 'Ceiling_wall_electrical_points_are_covered_or_capped_properly',
      photourl: this.imgURL14,
      Description: this.ionicForm.get('Ceiling_wall_electrical_points_are_covered_or_capped_properly_Description').value,
      timestamp: new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' })
    });
  ...
  sendMessage14(): void {
    this.newItem.user = this.au.email;
    this.newItem.inpect_title = 'Ceiling_wall_electrical_points_are_covered_or_capped_properly';
    //this.newItem1.photourl = this.imgURL1;
    this.newItem.Description = this.ionicForm.get('Ceiling_wall_electrical_points_are_covered_or_capped_properly_Description').value;
    this.newItem.timestamp = new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' });
    ...
    let email: any = {
      ...
      cc: 'sumathi@kraft-urspace.com',
      attachments: [],
      subject: 'Ceiling_wall_electrical_points_are_covered_or_capped_properly',
      body: [JSON.stringify(this.newItem)],
      isHtml: true
    };
  ...
  getGallery15() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Transition_betweeen_wooden_flooring_and_toilet_at_entry_Photo').setValue(this.imgURL15);
      this.upload15();
    });
  }
  ...
  getGallery16() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Vitrified_tile_flooring_is_consistent_and_free_of_hollowness_Photo').setValue(this.imgURL16);
      this.upload16();
    });
  }
  ...
  Save16(): void {
    ...
    this.servantroomdata.push({
      id: Date.now(),
      user: this.au.email,
      inpect_title: 'Vitrified_tile_flooring_is_consistent_and_free_of_hollowness',
      photourl: this.imgURL16,
      Description: this.ionicForm.get('Vitrified_tile_flooring_is_consistent_and_free_of_hollowness_Description').value,
      timestamp: new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' })
    });
  ...
  sendMessage16(): void {
    this.newItem.user = this.au.email;
    this.newItem.inpect_title = 'Vitrified_tile_flooring_is_consistent_and_free_of_hollowness';
    //this.newItem1.photourl = this.imgURL1;
    this.newItem.Description = this.ionicForm.get('Vitrified_tile_flooring_is_consistent_and_free_of_hollowness_Description').value;
    this.newItem.timestamp = new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' });
    ...
    let email: any = {
      ...
      cc: 'sumathi@kraft-urspace.com',
      attachments: [],
      subject: 'Vitrified_tile_flooring_is_consistent_and_free_of_hollowness',
      body: [JSON.stringify(this.newItem)],
      isHtml: true
    };
  ...
  getGallery17() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Skirting_finished_and_aligned_Photo').setValue(this.imgURL17);
      this.upload17();
    });
  }
  ...
  Save17(): void {
    ...
    this.servantroomdata.push({
      id: Date.now(),
      user: this.au.email,
      inpect_title: 'Skirting_finished_and_aligned',
      photourl: this.imgURL17,
      Description: this.ionicForm.get('Skirting_finished_and_aligned_Description').value,
      timestamp: new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' })
    });
  ...
  sendMessage17(): void {
    this.newItem.user = this.au.email;
    this.newItem.inpect_title = 'Skirting_finished_and_aligned';
    //this.newItem1.photourl = this.imgURL1;
    this.newItem.Description = this.ionicForm.get('Skirting_finished_and_aligned_Description').value;
    this.newItem.timestamp = new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' });
    ...
    let email: any = {
      ...
      cc: 'sumathi@kraft-urspace.com',
      attachments: [],
      subject: 'Skirting_finished_and_aligned',
      body: [JSON.stringify(this.newItem)],
      isHtml: true
    };
  ...
  getGallery18() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Cornices_provided_are_aligned_Photo').setValue(this.imgURL18);
      this.upload18();
    });
  }
  ...
  getGallery19() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Ceilings_are_free_of_stains_or_undulations_or_stains_etc_Photo').setValue(this.imgURL19);
      this.upload19();
    });
  }
  ...
  Save19(): void {
    ...
    this.servantroomdata.push({
      id: Date.now(),
      user: this.au.email,
      inpect_title: 'Ceilings_are_free_of_stains_or_undulations_or_stains_etc',
      photourl: this.imgURL19,
      Description: this.ionicForm.get('Ceilings_are_free_of_stains_or_undulations_or_stains_etc_Description').value,
      timestamp: new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' })
    });
  ...
  sendMessage19(): void {
    this.newItem.user = this.au.email;
    this.newItem.inpect_title = 'Ceilings_are_free_of_stains_or_undulations_or_stains_etc';
    //this.newItem1.photourl = this.imgURL1;
    this.newItem.Description = this.ionicForm.get('Ceilings_are_free_of_stains_or_undulations_or_stains_etc_Description').value;
    this.newItem.timestamp = new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' });
    ...
    let email: any = {
      ...
      cc: 'sumathi@kraft-urspace.com',
      attachments: [],
      subject: 'Ceilings_are_free_of_stains_or_undulations_or_stains_etc',
      body: [JSON.stringify(this.newItem)],
      isHtml: true
    };
  ...
  getGallery22() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Health_Faucet_is_functional_Photo').setValue(this.imgURL22);
      this.upload22();
    });
  }
  ...
  getGallery23() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Washbasin_and_counter_edges_are_sealed_Photo').setValue(this.imgURL23);
      this.upload23();
    });
  }
  ...
  Save23(): void {
    ...
    this.servantroomdata.push({
      id: Date.now(),
      user: this.au.email,
      inpect_title: 'Washbasin_and_counter_edges_are_sealed',
      photourl: this.imgURL23,
      Description: this.ionicForm.get('Washbasin_and_counter_edges_are_sealed_Description').value,
      timestamp: new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' })
    });
  ...
  sendMessage23(): void {
    this.newItem.user = this.au.email;
    this.newItem.inpect_title = 'Washbasin_and_counter_edges_are_sealed';
    //this.newItem1.photourl = this.imgURL1;
    this.newItem.Description = this.ionicForm.get('Washbasin_and_counter_edges_are_sealed_Description').value;
    this.newItem.timestamp = new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' });
    ...
    let email: any = {
      ...
      cc: 'sumathi@kraft-urspace.com',
      attachments: [],
      subject: 'Washbasin_and_counter_edges_are_sealed',
      body: [JSON.stringify(this.newItem)],
      isHtml: true
    };
  ...
  getGallery25() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Tile_drop_between_dry_and_wet_areas_exists_Photo').setValue(this.imgURL25);
      this.upload25();
    });
  }
  ...
  getGallery27() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Tiles_are_laid_to_slopewithout_hollowness_Photo').setValue(this.imgURL27);
      this.upload27();
    });
  }
  ...
  Save27(): void {
    ...
    this.servantroomdata.push({
      id: Date.now(),
      user: this.au.email,
      inpect_title: 'Tiles_are_laid_to_slopewithout_hollowness',
      photourl: this.imgURL27,
      Description: this.ionicForm.get('Tiles_are_laid_to_slopewithout_hollowness_Description').value,
      timestamp: new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' })
    });
  ...
  sendMessage27(): void {
    this.newItem.user = this.au.email;
    this.newItem.inpect_title = 'Tiles_are_laid_to_slopewithout_hollowness';
    //this.newItem1.photourl = this.imgURL1;
    this.newItem.Description = this.ionicForm.get('Tiles_are_laid_to_slopewithout_hollowness_Description').value;
    this.newItem.timestamp = new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' });
  ...
  getGallery28() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Shower_head_Photo').setValue(this.imgURL28);
      this.upload28();
    });
  }
  ...
  getGallery29() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('EWC_Photo').setValue(this.imgURL29);
      this.upload29();
    });
  }
  ...
  getGallery34() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Vertical_Tiles_joints_and_ceiling_support_members_are_aligned_Photo').setValue(this.imgURL34);
      this.upload34();
    });
  }
  ...
  getGallery35() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Service_ledge_is_painted_and_clean_Photo').setValue(this.imgURL35);
      this.upload35();
    });
  }
  ...
  getGallery36() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Ceiling_tiles_are_free_of_stains_or_undulations_or_cracks_etc_Photo').setValue(this.imgURL36);
      this.upload36();
    });
  }
  ...
  Save36(): void {
    ...
    this.servantroomdata.push({
      id: Date.now(),
      user: this.au.email,
      inpect_title: 'Ceiling_tiles_are_free_of_stains_or_undulations_or_cracks_etc',
      photourl: this.imgURL36,
      Description: this.ionicForm.get('Ceiling_tiles_are_free_of_stains_or_undulations_or_cracks_etc_Description').value,
      timestamp: new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' })
    });
  ...
  sendMessage36(): void {
    this.newItem.user = this.au.email;
    this.newItem.inpect_title = 'Ceiling_tiles_are_free_of_stains_or_undulations_or_cracks_etc';
    //this.newItem1.photourl = this.imgURL1;
    this.newItem.Description = this.ionicForm.get('Ceiling_tiles_are_free_of_stains_or_undulations_or_cracks_etc_Description').value;
    this.newItem.timestamp = new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' });
    ...
    let email: any = {
      ...
      cc: 'sumathi@kraft-urspace.com',
      attachments: [],
      subject: 'Ceiling_tiles_are_free_of_stains_or_undulations_or_cracks_etc',
      body: [JSON.stringify(this.newItem)],
      isHtml: true
    };
  ...
  getGallery37() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Tile_Dado_surface_is_consistent_and_without_hollowness_Photo').setValue(this.imgURL37);
      this.upload37();
    });
  }
  ...
  getGallery38() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('EWC_Ledge_wall_granite_coping_is_free_of_sharp_edges_Photo').setValue(this.imgURL38);
      this.upload38();
    });
  }
  ...
  getGallery39() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Area_above_false_ceiling_is_painted_Photo').setValue(this.imgURL40);
      this.upload39();
    });
  }
  ...
  submitForm(): void {
    ...
    this.AssetData = JSON.stringify(this.servantroomdata);
    this.DiningData = JSON.parse(this.AssetData);
    console.log('formdata collection', this.DiningData);

    washingtonRef
      .update({
        servantRoom: arrayUnion({
          servantRoom_data: this.DiningData
        })
      })
      .then(function () {
  ...
  exportCSV() {
    this.storageService.setObject('socialdata', this.servantroomdata);

    var csv = this.papa.unparse(this.servantroomdata);
  ...
  Transition_betweeen_wooden(): void {
  ...
  Ceilings_are_free_of_stains_or_undulations_or_stains_etc(): void {
    let Qvalue = this.ionicForm.get('Ceilings_are_free_of_stains_or_undulations_or_stains_etc').value;
    console.log('Q---->', Qvalue);
    if (Qvalue === 'No') {
