...
interface StudentData {
  ...
  Floor_traps_are_clean_and_free_of_rust: string;
  Floor_traps_are_clean_and_free_of_rust_Photo: any;
  Floor_traps_are_clean_and_free_of_rust_Description: string;
...
@Component({
  selector: 'app-l-balcony',
  templateUrl: './l-balcony.page.html',
  styleUrls: ['./l-balcony.page.scss']
})
export class LBalconyPage implements OnInit {
  //new
  completiontime: any;
  flist: any;
  flatnumber: any;
  ...
  ngOnInit() {
    ...
    this.ionicForm = this.formBuilder.group({
      ...
      Floor_traps_are_clean_and_free_of_rust: [''],
      Floor_traps_are_clean_and_free_of_rust_Photo: [''],
      Floor_traps_are_clean_and_free_of_rust_Description: [''],
      ...
      Vertical_texture_painted_surfaces_are_free_of_undulations_Photo: [''],
      ...
      Elevational_ledge_horizontal_surface_finish: [''],
  ...
  getGallery1() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('UPVC_balcony_doors_are_operable_Photo').setValue(this.imgURL1);
      this.upload1();
    });
  }
  ...
  Save1(): void {
    ...
    console.log('lbalconydata', JSON.stringify(this.lbalconydata));
  }
  sendMessage1(): void {
  ...
  getGallery2() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Aluminium_channel_below_balcony_door_is_cleaned_Photo').setValue(this.imgURL2);
  ...
  getGallery3() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Gaskets_or_Sealants_are_intact_Photo').setValue(this.imgURL3);
      ///this.ionicForm[].Electrical_wall_and_ceiling_points_are_covered_Photo=this.imgURL1;
      // this.currentImage = this.imgURL1;
  ...
  getGallery4() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('UPVC_balcony_doors_are_without_sharp_edges_Photo').setValue(this.imgURL4);
      this.upload4();
    });
  }
  ...
  getGallery7() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Ceiling_and_wall_electrical_points_are_covered_or_capped_properly_Photo').setValue(this.imgURL7);
      this.upload7();
    });
  }
  ...
  getGallery8() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Electrical_points_are_as_per_standard_offering_Photo').setValue(this.imgURL8);
      this.upload8();
    });
  }
  ...
  getGallery9() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Electrical_points_are_as_per_standard_offering_Photo').setValue(this.imgURL9);
      this.upload9();
    });
  }
  ...
  getGallery10() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('AC_Core_cut_pipe_is_cleaned_Photo').setValue(this.imgURL10);
      this.upload10();
    });
  }
  ...
  getGallery12() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Floor_traps_are_clean_and_free_of_rust_Photo').setValue(this.imgURL12);
      this.upload12();
    });
  }
  ...
  Save12() {
    ...
    this.lbalconydata.push({
      id: Date.now(),
      user: this.au.email,
      inpect_title: 'Floor_traps_are_clean_and_free_of_rust_properly',
      photourl: this.imgURL12,
      Description: this.ionicForm.get('Floor_traps_are_clean_and_free_of_rust_Description').value,
      timestamp: new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' })
    });
  ...
  sendMessage12(): void {
    this.newItem.user = this.au.email;
    this.newItem.inpect_title = 'Floor_traps_are_clean_and_free_of_rust_properly';
    //this.newItem1.photourl = this.imgURL1;
    this.newItem.Description = this.ionicForm.get('Floor_traps_are_clean_and_free_of_rust_Description').value;
    this.newItem.timestamp = new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' });
    ...
    let email: any = {
      ...
      cc: 'sumathi@kraft-urspace.com',
      attachments: [],
      subject: 'Floor_traps_are_clean_and_free_of_rust_properly',
      body: [JSON.stringify(this.newItem)],
      isHtml: true
    };
  ...
  getGallery13() {
    ...
    this.camera.getPicture(options).then(imageData => {
      this.picdata = imageData;
      this.imgURL12 = 'data:image/jpeg;base64,' + imageData;
      this.ionicForm.get('Floor_Slopes_provided_are_adequate_Photo').setValue(this.imgURL12);
      this.upload13();
    });
  }
  ...
  getGallery14() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Vitrified_tiles_are_uniform_free_of_cracks_and_hollowness_Photo').setValue(this.imgURL14);
      this.upload14();
    });
  }
  ...
  Save14(): void {
    ...
    this.lbalconydata.push({
      ...
      Description: this.ionicForm.get('Vitrified_tiles_are_uniform_free_of_cracks_and_hollowness_Description').value,
      timestamp: new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' })
    });
  ...
  sendMessage14(): void {
    this.newItem.user = this.au.email;
    this.newItem.inpect_title = 'Vitrified_tiles_are_uniform_free_of_cracks_and_hollowness';
    //this.newItem1.photourl = this.imgURL1;
    this.newItem.Description = this.ionicForm.get('Vitrified_tiles_are_uniform_free_of_cracks_and_hollowness_Description').value;
    this.newItem.timestamp = new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' });
    ...
    let email: any = {
      ...
      cc: 'sumathi@kraft-urspace.com',
      attachments: [],
      subject: 'Vitrified_tiles_are_uniform_free_of_cracks_and_hollowness',
      body: [JSON.stringify(this.newItem)],
      isHtml: true
    };
  ...
  getGallery15() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Skirting_finish_and_alignment_is_correct_Photo').setValue(this.imgURL15);
      this.upload15();
    });
  }
  ...
  Save15(): void {
    ...
    this.lbalconydata.push({
      ...
      Description: this.ionicForm.get('Skirting_finish_and_alignment_is_correct_Description').value,
      timestamp: new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' })
    });
  ...
  sendMessage15(): void {
    this.newItem.user = this.au.email;
    this.newItem.inpect_title = 'Skirting_finish_and_alignment_is_correct';
    //this.newItem1.photourl = this.imgURL1;
    this.newItem.Description = this.ionicForm.get('Skirting_finish_and_alignment_is_correct_Description').value;
    this.newItem.timestamp = new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' });
    ...
    let email: any = {
      ...
      cc: 'sumathi@kraft-urspace.com',
      attachments: [],
      subject: 'Skirting_finish_and_alignment_is_correct',
      body: [JSON.stringify(this.newItem)],
      isHtml: true
    };
  ...
  getGallery16() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Granite_edge_provided_is_free_of_cracks_and_sharp_edges_Photo').setValue(this.imgURL16);
      this.upload16();
    });
  }
  ...
  Save16(): void {
    ...
    this.lbalconydata.push({
      id: Date.now(),
      user: this.au.email,
      inpect_title: 'Granite_edge_provided_is_free_of_cracks_and_sharp_edges',
      photourl: this.imgURL16,
      Description: this.ionicForm.get('Granite_edge_provided_is_free_of_cracks_and_sharp_edges_Description').value,
      timestamp: new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' })
    });
  ...
  sendMessage16(): void {
    this.newItem.user = this.au.email;
    this.newItem.inpect_title = 'Granite_edge_provided_is_free_of_cracks_and_sharp_edges';
    //this.newItem1.photourl = this.imgURL1;
    this.newItem.Description = this.ionicForm.get('Granite_edge_provided_is_free_of_cracks_and_sharp_edges_Description').value;
    this.newItem.timestamp = new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' });
    ...
    let email: any = {
      ...
      cc: 'sumathi@kraft-urspace.com',
      attachments: [],
      subject: 'Granite_edge_provided_is_free_of_cracks_and_sharp_edges',
      body: [JSON.stringify(this.newItem)],
      isHtml: true
    };
  ...
  getGallery17() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Vertical_texture_painted_surfaces_are_free_of_undulations_Photo').setValue(this.imgURL17);
      this.upload17();
    });
  }
  ...
  Save17(): void {
    ...
    this.lbalconydata.push({
      ...
      Description: this.ionicForm.get('Vertical_texture_painted_surfaces_are_free_of_undulations_Description').value,
      timestamp: new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' })
    });
  ...
  sendMessage17(): void {
    this.newItem.user = this.au.email;
    this.newItem.inpect_title = 'Vertical_texture_painted_surfaces_are_free_of_undulations';
    //this.newItem1.photourl = this.imgURL1;
    this.newItem.Description = this.ionicForm.get('Vertical_texture_painted_surfaces_are_free_of_undulations_Description').value;
    this.newItem.timestamp = new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' });
    ...
    let email: any = {
      ...
      cc: 'sumathi@kraft-urspace.com',
      attachments: [],
      subject: 'Vertical_texture_painted_surfaces_are_free_of_undulations',
      body: [JSON.stringify(this.newItem)],
      isHtml: true
    };
  ...
  getGallery18() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('WSS_pipe_railing_is_finshed_with_smooth_edges_Photo').setValue(this.imgURL18);
      this.upload18();
    });
  }
  ...
  Save18(): void {
    ...
    this.lbalconydata.push({
      id: Date.now(),
      user: this.au.email,
      inpect_title: 'WSS_pipe_railing_is_finshed_with_smooth_edges',
      photourl: this.imgURL18,
      Description: this.ionicForm.get('WSS_pipe_railing_is_finshed_with_smooth_edges_Description').value,
      timestamp: new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' })
    });
  ...
  sendMessage18(): void {
    this.newItem.user = this.au.email;
    this.newItem.inpect_title = 'WSS_pipe_railing_is_finshed_with_smooth_edges';
    //this.newItem1.photourl = this.imgURL1;
    this.newItem.Description = this.ionicForm.get('WSS_pipe_railing_is_finshed_with_smooth_edges_Description').value;
    this.newItem.timestamp = new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' });
    ...
    let email: any = {
      ...
      cc: 'sumathi@kraft-urspace.com',
      attachments: [],
      subject: 'WSS_pipe_railing_is_finshed_with_smooth_edges',
      body: [JSON.stringify(this.newItem)],
      isHtml: true
    };
  ...
  getGallery19() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('SS_pipe_railing_height_is_consistent_Photo').setValue(this.imgURL19);
      this.upload19();
    });
  }
  ...
  getGallery20() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('SS_pipe_railing_end_caps_are_fixed_without_gaps_Photo').setValue(this.imgURL20);
      this.upload20();
    });
  }
  ...
  getGallery21() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Glass_in_railing_is_free_of_scratches_Photo').setValue(this.imgURL21);
      this.upload21();
    });
  }
  ...
  getGallery23() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Internal_surfaces_is_cleaned_and_painted_Photo').setValue(this.imgURL23);
      this.upload23();
    });
  }
  ...
  getGallery26() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('MS_Duct_door_frames_and_wall_junctions_are_sealed_Photo').setValue(this.imgURL26);
      this.upload26();
    });
  }
  ...
  getGallery29() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Ceilings_are_free_of_stains_or_undulations_or_cracks_etc_Photo').setValue(this.imgURL29);
      this.upload29();
    });
  }
  ...
  getGallery31() {
    ...
    this.camera.getPicture(options).then(imageData => {
      this.picdata = imageData;
      this.imgURL30 = 'data:image/jpeg;base64,' + imageData;
      this.ionicForm.get('Walls_are_free_of_cracks_or_stains_etc_Photo').setValue(this.imgURL30);
      this.upload31();
    });
  }
  ...
  submitForm(): void {
    ...
    washingtonRef
      .update({
        LivingRoom_balcony: arrayUnion({
          LivingRoom_balcony_data: this.DiningData
        })
      })
      .then(function () {
  ...
  exportCSV() {
    this.storageService.setObject('socialdata', this.lbalconydata);

    var csv = this.papa.unparse(this.lbalconydata);

    if (this.platform.is('cordova')) {
      this.file.writeFile(this.file.dataDirectory, 'LivingRoom_balcony.csv', csv, { replace: true }).then(
        res => {
          this.socialSharing
  ...
  Floor_traps_are_clean_and_free_of_rust(): void {
    let Qvalue = this.ionicForm.get('Floor_traps_are_clean_and_free_of_rust').value;
    console.log('Q---->', Qvalue);
    if (Qvalue === 'No') {
