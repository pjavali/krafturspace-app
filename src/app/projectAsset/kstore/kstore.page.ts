...
export class KStorePage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.ionicForm = this.formBuilder.group({
      ...
      Door_stopper_is_functional_Photo: [''],
      ...
      Door_frame_is_consistent_without_dent_or_cratches_or_arks_Photo: [''],
      ...
      Wall_Light_points_are_covered_or_apped_properly_Photo: [''],
      Wall_Light_points_are_covered_or_apped_properly_Description: [''],

      Ceiling_electrical_points_are_covered_or_apped_properly: [''],
      Ceiling_electrical_points_are_covered_or_apped_properly_Photo: [''],
      ...
      Ceilings_are_free_of_stains_or_ndulations_or_tains_etc_Photo: [''],
  ...
  getGallery1() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Door_stopper_is_functional_Photo').setValue(this.imgURL1);
      this.upload1();
    });
  }
  ...
  Save1(): void {
    ...
    this.kstoreData.push({
      ...
      inpect_title: 'Door_stopper_is_functional',
      photourl: this.picdata,
      Description: this.ionicForm.get('Door_stopper_is_functional_Description').value,
      timestamp: new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' })
    });

    console.log('kstoreData', JSON.stringify(this.kstoreData));
  }
  sendMessage1(): void {
    this.newItem.user = this.au.email;
    this.newItem.inpect_title = 'Door_stopper_is_functional';
    //this.newItem1.photourl = this.imgURL1;
    this.newItem.Description = this.ionicForm.get('Door_stopper_is_functional_Description').value;
    ...
    let email: any = {
      ...
      attachments: [],
      subject: 'Door_stopper_is_functional',
  ...
  getGallery4() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Gaskets_or_ealents_are_intact_Photo').setValue(this.imgURL4);
      this.upload4();
    });
  }
  ...
  getGallery5() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Door_frame_is_consistent_without_dent_or_cratches_or_arks_Photo').setValue(this.imgURL5);
      this.upload5();
    });
  }
  ...
  Save5(): void {
    ...
    this.kstoreData.push({
      id: Date.now(),
      user: this.au.email,
      inpect_title: 'Door_frame_is_consistent_without_dent_or_cratches_or_arks',
      photourl: this.imgURL5,
      Description: this.ionicForm.get('Door_frame_is_consistent_without_dent_or_cratches_or_arks_Description').value,
      timestamp: new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' })
    });
  ...
  sendMessage5(): void {
    this.newItem.user = this.au.email;
    this.newItem.inpect_title = 'Door_frame_is_consistent_without_dent_or_cratches_or_arks';
    //this.newItem1.photourl = this.imgURL1;
    this.newItem.Description = this.ionicForm.get('Door_frame_is_consistent_without_dent_or_cratches_or_arks_Description').value;
    this.newItem.timestamp = new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' });
    ...
    let email: any = {
      ...
      cc: 'sumathi@kraft-urspace.com',
      attachments: [],
      subject: 'Door_frame_is_consistent_without_dent_or_cratches_or_arks',
      body: [JSON.stringify(this.newItem)],
      isHtml: true
    };
  ...
  getGallery6() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Door_color_is_consistent_Photo').setValue(this.imgURL6);
      this.upload6();
    });
  }
  ...
  getGallery7() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('UPVC_door_glass_is_free_of_scratches_Photo').setValue(this.imgURL7);
      this.upload7();
    });
  }
  ...
  Save7(): void {
    ...
    this.kstoreData.push({
      id: Date.now(),
      user: this.au.email,
      inpect_title: 'UPVC_door_glass_is_free_of_scratches',
      photourl: this.imgURL7,
      Description: this.ionicForm.get('UPVC_door_glass_is_free_of_scratches_Description').value,
      timestamp: new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' })
    });
  ...
  sendMessage7(): void {
    this.newItem.user = this.au.email;
    this.newItem.inpect_title = 'UPVC_door_glass_is_free_of_scratches';
    //this.newItem1.photourl = this.imgURL1;
    this.newItem.Description = this.ionicForm.get('UPVC_door_glass_is_free_of_scratches_Description').value;
    this.newItem.timestamp = new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' });
    ...
    let email: any = {
      ...
      cc: 'sumathi@kraft-urspace.com',
      attachments: [],
      subject: 'UPVC_door_glass_is_free_of_scratches',
      body: [JSON.stringify(this.newItem)],
      isHtml: true
    };
  ...
  getGallery8() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('UPVC_doors_are_operable_Photo').setValue(this.imgURL8);
      this.upload8();
    });
  }
  ...
  Save8(): void {
    ...
    this.kstoreData.push({
      id: Date.now(),
      user: this.au.email,
      inpect_title: 'UPVC_doors_are_operable',
      photourl: this.imgURL8,
      Description: this.ionicForm.get('UPVC_doors_are_operable_Description').value,
      timestamp: new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' })
    });
  ...
  sendMessage8(): void {
    this.newItem.user = this.au.email;
    this.newItem.inpect_title = 'UPVC_doors_are_operable';
    //this.newItem1.photourl = this.imgURL1;
    this.newItem.Description = this.ionicForm.get('UPVC_doors_are_operable_Description').value;
    this.newItem.timestamp = new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' });
    ...
    let email: any = {
      ...
      cc: 'sumathi@kraft-urspace.com',
      attachments: [],
      subject: 'UPVC_doors_are_operable',
      body: [JSON.stringify(this.newItem)],
      isHtml: true
    };
  ...
  getGallery9() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Hardware_is_as_per_standard_offering_Photo').setValue(this.imgURL9);
      this.upload9();
    });
  }
  ...
  getGallery11() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Wall_Light_points_are_covered_or_apped_properly_Photo').setValue(this.imgURL11);
      this.upload11();
    });
  }
  ...
  Save11() {
    ...
    this.kstoreData.push({
      id: Date.now(),
      user: this.au.email,
      inpect_title: 'Wall_Light_points_are_covered_or_apped_properly',
      photourl: this.imgURL11,
      Description: this.ionicForm.get('Wall_Light_points_are_covered_or_apped_properly_Description').value,
      timestamp: new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' })
    });
  ...
  sendMessage11() {
    this.newItem.user = this.au.email;
    this.newItem.inpect_title = 'Wall_Light_points_are_covered_or_apped_properly';
    //this.newItem1.photourl = this.imgURL1;
    this.newItem.Description = this.ionicForm.get('Wall_Light_points_are_covered_or_apped_properly_Description').value;
    this.newItem.timestamp = new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' });
    ...
    let email: any = {
      ...
      cc: 'sumathi@kraft-urspace.com',
      attachments: [],
      subject: 'Wall_Light_points_are_covered_or_apped_properly',
      body: [JSON.stringify(this.newItem)],
      isHtml: true
    };
  ...
  getGallery13() {
    ...
    this.camera.getPicture(options).then(imageData => {
      this.picdata = imageData;
      this.imgURL12 = 'data:image/jpeg;base64,' + imageData;
      this.ionicForm.get('Ceiling_electrical_points_are_covered_or_apped_properly_Photo').setValue(this.imgURL12);
      this.upload13();
    });
  }
  ...
  Save13(): void {
    ...
    this.kstoreData.push({
      id: Date.now(),
      user: this.au.email,
      inpect_title: 'Ceiling_electrical_points_are_covered_or_apped_properly',
      photourl: this.imgURL13,
      Description: this.ionicForm.get('Ceiling_electrical_points_are_covered_or_apped_properly_Description').value,
      timestamp: new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' })
    });
  ...
  sendMessage13(): void {
    this.newItem.user = this.au.email;
    this.newItem.inpect_title = 'Ceiling_electrical_points_are_covered_or_apped_properly';
    //this.newItem1.photourl = this.imgURL1;
    this.newItem.Description = this.ionicForm.get('Ceiling_electrical_points_are_covered_or_apped_properly_Description').value;
    this.newItem.timestamp = new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' });
    ...
    let email: any = {
      ...
      cc: 'sumathi@kraft-urspace.com',
      attachments: [],
      subject: 'Ceiling_electrical_points_are_covered_or_apped_properly',
      body: [JSON.stringify(this.newItem)],
      isHtml: true
    };
  ...
  getGallery16() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Skirting_finish__and_alignment_Photo').setValue(this.imgURL16);
      this.upload16();
    });
  }
  ...
  Save16(): void {
    ...
    this.kstoreData.push({
      id: Date.now(),
      user: this.au.email,
      inpect_title: 'Skirting_finish__and_alignment',
      photourl: this.imgURL16,
      Description: this.ionicForm.get('Skirting_finish__and_alignment_Description').value,
      timestamp: new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' })
    });
  ...
  sendMessage16(): void {
    this.newItem.user = this.au.email;
    this.newItem.inpect_title = 'Skirting_finish__and_alignment';
    //this.newItem1.photourl = this.imgURL1;
    this.newItem.Description = this.ionicForm.get('Skirting_finish__and_alignment_Description').value;
    this.newItem.timestamp = new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' });
    ...
    let email: any = {
      ...
      cc: 'sumathi@kraft-urspace.com',
      attachments: [],
      subject: 'Skirting_finish__and_alignment',
      body: [JSON.stringify(this.newItem)],
      isHtml: true
    };
  ...
  getGallery17() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Electrical_ceiling_points_are_covered_Photo').setValue(this.imgURL17);
      this.upload17();
    });
  }
  ...
  Save17(): void {
    ...
    this.kstoreData.push({
      id: Date.now(),
      user: this.au.email,
      inpect_title: 'Electrical_ceiling_points_are_covered',
      photourl: this.imgURL17,
      Description: this.ionicForm.get('Electrical_ceiling_points_are_covered_Description').value,
      timestamp: new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' })
    });
  ...
  sendMessage17(): void {
    this.newItem.user = this.au.email;
    this.newItem.inpect_title = 'Electrical_ceiling_points_are_covered';
    //this.newItem1.photourl = this.imgURL1;
    this.newItem.Description = this.ionicForm.get('Electrical_ceiling_points_are_covered_Description').value;
    this.newItem.timestamp = new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' });
    ...
    let email: any = {
      ...
      cc: 'sumathi@kraft-urspace.com',
      attachments: [],
      subject: 'Electrical_ceiling_points_are_covered',
      body: [JSON.stringify(this.newItem)],
      isHtml: true
    };
  ...
  getGallery18() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Transition_betweeen_Corridor_and_vitrified_flooring_Photo').setValue(this.imgURL18);
      this.upload18();
    });
  }
  ...
  Save18(): void {
    ...
    this.kstoreData.push({
      id: Date.now(),
      user: this.au.email,
      inpect_title: 'Transition_betweeen_Corridor_and_vitrified_flooring',
      photourl: this.imgURL18,
      Description: this.ionicForm.get('Transition_betweeen_Corridor_and_vitrified_flooring_Description').value,
      timestamp: new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' })
    });
  ...
  sendMessage18(): void {
    this.newItem.user = this.au.email;
    this.newItem.inpect_title = 'Transition_betweeen_Corridor_and_vitrified_flooring';
    //this.newItem1.photourl = this.imgURL1;
    this.newItem.Description = this.ionicForm.get('Transition_betweeen_Corridor_and_vitrified_flooring_Description').value;
    this.newItem.timestamp = new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' });
    ...
    let email: any = {
      ...
      cc: 'sumathi@kraft-urspace.com',
      attachments: [],
      subject: 'Transition_betweeen_Corridor_and_vitrified_flooring',
      body: [JSON.stringify(this.newItem)],
      isHtml: true
    };
  ...
  getGallery19() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Cornices_provided_are_aligned_Photo').setValue(this.imgURL19);
      this.upload19();
    });
  }
  ...
  getGallery20() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Ceilings_are_free_of_stains_or_ndulations_or_tains_etc_Photo').setValue(this.imgURL20);
      this.upload20();
    });
  }
  ...
  Save20(): void {
    ...
    this.kstoreData.push({
      id: Date.now(),
      user: this.au.email,
      inpect_title: 'Ceilings_are_free_of_stains_or_ndulations_or_tains_etc',
      photourl: this.imgURL20,
      Description: this.ionicForm.get('Ceilings_are_free_of_stains_or_ndulations_or_tains_etc_Description').value,
      timestamp: new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' })
    });
  ...
  sendMessage20(): void {
    this.newItem.user = this.au.email;
    this.newItem.inpect_title = 'Ceilings_are_free_of_stains_or_ndulations_or_tains_etc';
    //this.newItem1.photourl = this.imgURL1;
    this.newItem.Description = this.ionicForm.get('Ceilings_are_free_of_stains_or_ndulations_or_tains_etc_Description').value;
    this.newItem.timestamp = new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' });
    ...
    let email: any = {
      ...
      cc: 'sumathi@kraft-urspace.com',
      attachments: [],
      subject: 'Ceilings_are_free_of_stains_or_ndulations_or_tains_etc',
      body: [JSON.stringify(this.newItem)],
      isHtml: true
    };
  ...
  getGallery21() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Walls_are_free_of_cracks_or_stains_etc_Photo').setValue(this.imgURL21);
      this.upload21();
    });
  }
  ...
  submitForm(): void {
    ...
    this.AssetData = JSON.stringify(this.kstoreData);
    this.DiningData = JSON.parse(this.AssetData);
    console.log('formdata collection', this.DiningData);

    washingtonRef
      .update({
        kitchen_store: arrayUnion({
          kitchen_store_Data: this.DiningData
        })
      })
      .then(function () {
  ...
  exportCSV() {
    this.storageService.setObject('socialdata', this.kstoreData);

    var csv = this.papa.unparse(this.kstoreData);

    if (this.platform.is('cordova')) {
      this.file.writeFile(this.file.dataDirectory, 'kitchen_store_Data.csv', csv, { replace: true }).then(
        res => {
          this.socialSharing
      ...
      a.download = 'kitchen_store_Data.csv';
