    ...
    this.ionicForm = this.formBuilder.group({
      ...
      Doors_and_Windows:['', [Validators.required]], 
               ...
               UPVC_exterior_windows_are_free_of_sharp_edges:['', [Validators.required]], 
                UPVC_exterior_windows_are_free_of_sharp_edges_Photo: [this.imgURL1, [Validators.required]],
              UPVC_exterior_windows_are_free_of_sharp_edges_Description:['', [Validators.required]], 

               UPVC_utility_doors_are_free_of_sharp_edges:['', [Validators.required]], 
                UPVC_utility_doors_are_free_of_sharp_edges_Photo: [this.imgURL2, [Validators.required]],
                 UPVC_utility_doors_are_free_of_sharp_edges_Description:['', [Validators.required]], 
                
              UPVC_exterior_windows_are_operable:['', [Validators.required]], 
              UPVC_exterior_windows_are_operable_Photo: [this.imgURL3, [Validators.required]],
              UPVC_exterior_windows_are_operable_Description:['', [Validators.required]], 
              
               UPVC_utility_doors_are_operable:['', [Validators.required]], 
                UPVC_utility_doors_are_operable_Photo: [this.imgURL4, [Validators.required]],
              UPVC_utility_doors_are_operable_Description:['', [Validators.required]], 

               Gaskets_or_ealents_are_intact:['', [Validators.required]], 
                Gaskets_or_ealents_are_intact_Photo: [this.imgURL5, [Validators.required]],
              Gaskets_or_ealents_are_intact_Description:['', [Validators.required]], 

              UPVC_exterior_window_bug_screen_mesh_is_taut:['', [Validators.required]], 
              UPVC_exterior_window_bug_screen_mesh_is_taut_Photo: [this.imgURL6, [Validators.required]],
              UPVC_exterior_window_bug_screen_mesh_is_taut_Description:['', [Validators.required]], 

               UPVC_exterior_window_bug_screen_is_operable:['', [Validators.required]], 
                UPVC_exterior_window_bug_screen_is_operable_Photo: [this.imgURL7, [Validators.required]],
              UPVC_exterior_window_bug_screen_is_operable_Description:['', [Validators.required]], 
           
            Flooring:['', [Validators.required]], 
            
               Floor_slope_is_adequate:['', [Validators.required]], 
                Floor_slope_is_adequate_Photo: [this.imgURL8, [Validators.required]],
              Floor_slope_is_adequate_Description:['', [Validators.required]], 

             Skirting_finish__and_alignment:['', [Validators.required]], 
              Skirting_finish__and_alignment_Photo: [this.imgURL9, [Validators.required]],
              ...
              Vitrified_flooring_tiles_are_uniform_and_free_of_cracks_Photo: [this.imgURL10, [Validators.required]],
              Vitrified_flooring_tiles_are_uniform_and_free_of_cracks_Description:['', [Validators.required]], 
           
            PHE:['', [Validators.required]], 
               Floor_trap_cover_is_provided:['', [Validators.required]], 
                Floor_trap_cover_is_provided_Photo: [this.imgURL11, [Validators.required]],
              Floor_trap_cover_is_provided_Description:['', [Validators.required]], 

              Brackets_supporting_counter_is_painted__and_free_of_rust:['', [Validators.required]], 
              Brackets_supporting_counter_is_painted__and_free_of_rust_Photo: [this.imgURL12, [Validators.required]],
              Brackets_supporting_counter_is_painted__and_free_of_rust_Description:['', [Validators.required]], 

               Granite_counter_is_free_of_sharp_edges:['', [Validators.required]], 
                Granite_counter_is_free_of_sharp_edges_Photo: [this.imgURL13, [Validators.required]],
              Granite_counter_is_free_of_sharp_edges_Description:['', [Validators.required]], 

               Sink_faucet_is_operable:['', [Validators.required]], 
                Sink_faucet_is_operable_Photo: [this.imgURL14, [Validators.required]],
              Sink_faucet_is_operable_Description:['', [Validators.required]], 

              Sink_and_counter_edges_are_sealed:['', [Validators.required]], 
              Sink_and_counter_edges_are_sealed_Photo: [this.imgURL15, [Validators.required]],
              Sink_and_counter_edges_are_sealed_Description:['', [Validators.required]], 

               Floor_trap_below_cover_is_clean :['', [Validators.required]], 
                Floor_trap_below_cover_is_clean_Photo: [this.imgURL16, [Validators.required]],
            ...
            Shafts:['', [Validators.required]], 
               MS_Duct_doors_are_painted_on_both_sides:['', [Validators.required]], 
                MS_Duct_doors_are_painted_on_both_sides_Photo: [this.imgURL17, [Validators.required]],
              MS_Duct_doors_are_painted_on_both_sides_Description:['', [Validators.required]], 
               ...
               Internal_surfaces_is_cleaned_and_painted:['', [Validators.required]], 
                Internal_surfaces_is_cleaned_and_painted_Photo: [this.imgURL18, [Validators.required]],
             ...
             Shaft_internals_to_be_painted:['', [Validators.required]], 
              Shaft_internals_to_be_painted_Photo: [this.imgURL19, [Validators.required]],
              Shaft_internals_to_be_painted_Description:['', [Validators.required]], 

              MS_Duct_door_frames__and_wall_junctions_are_sealed:['', [Validators.required]], 
              MS_Duct_door_frames__and_wall_junctions_are_sealed_Photo: [this.imgURL20, [Validators.required]],
              MS_Duct_door_frames__and_wall_junctions_are_sealed_Description:['', [Validators.required]], 

               Shaft_internals_to_be_free_of_debris:['', [Validators.required]], 
                Shaft_internals_to_be_free_of_debris_Photo: [this.imgURL21, [Validators.required]],
              Shaft_internals_to_be_free_of_debris_Description:['', [Validators.required]], 
           
            Walls_and_ceiling:['', [Validators.required]], 
               Junctions_betweeen_door_frame__and_wall_is_finished:['', [Validators.required]], 
                Junctions_betweeen_door_frame__and_wall_is_finished_Photo: [this.imgURL22, [Validators.required]],
              Junctions_betweeen_door_frame__and_wall_is_finished_Description:['', [Validators.required]], 
             ...
             Wall_dado_is_consistent:['', [Validators.required]], 
              Wall_dado_is_consistent_Photo: [this.imgURL24, [Validators.required]],
              Wall_dado_is_consistent_Description:['', [Validators.required]], 

            Junction_between_dado_and_wall_plaster_is_uniformly_finished:['', [Validators.required]], 
              Junction_between_dado_and_wall_plaster_is_uniformly_finished_Photo: [this.imgURL25, [Validators.required]],
              Junction_between_dado_and_wall_plaster_is_uniformly_finished_Description:['', [Validators.required]], 

               Wall_dado_is_free_of_hollowness :['', [Validators.required]], 
                Wall_dado_is_free_of_hollowness_Photo: [this.imgURL26, [Validators.required]],
              Wall_dado_is_free_of_hollowness_Description:['', [Validators.required]], 
              
               Walls_are_free_of_cracks_or_stains_etc:['', [Validators.required]], 
                Walls_are_free_of_cracks_or_stains_etc_Photo: [this.imgURL27, [Validators.required]],
