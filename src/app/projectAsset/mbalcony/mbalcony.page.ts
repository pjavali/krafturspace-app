...
@Component({
  selector: 'app-mbalcony',
  templateUrl: './mbalcony.page.html',
  styleUrls: ['./mbalcony.page.scss']
})
export class MBalconyPage implements OnInit {
  //new
  completiontime: any;
  flist: any;
  flatnumber: any;
  ...
  save1(): void {
    ...
    console.log('mbalconydata', JSON.stringify(this.mbalconydata));
  }
  sendMessage1(): void {
  ...
  submitForm(): void {
    ...
    this.AssetData = JSON.stringify(this.mbalconydata);
    this.DiningData = JSON.parse(this.AssetData);
    console.log('formdata collection', this.DiningData);

    washingtonRef
      .update({
        masterbedroomm_balcony: arrayUnion({
          masterbedroomm_balcony_data: this.DiningData
        })
      })
      .then(function () {
  ...
  exportCSV() {
    this.storageService.setObject('socialdata', this.mbalconydata);

    var csv = this.papa.unparse(this.mbalconydata);
