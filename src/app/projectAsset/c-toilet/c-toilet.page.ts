...
interface StudentData {
  ...
  Wash_Basinf: string;
  Wash_Basinf_Photo: any;
  Wash_Basinf_Description: string;
  Wash_Basin_in_mm: string;

  Wash_basin_faucet_is_functional: string;
...
@Component({
  selector: 'app-c-toilet',
  templateUrl: './c-toilet.page.html',
  styleUrls: ['./c-toilet.page.scss']
})
export class CToiletPage implements OnInit {
  //new
  ...
  ngOnInit() {
    ...
    this.ionicForm = this.formBuilder.group({
      ...
      Tile_Dado_urface_is_consistent_and_without_hollowness_Photo: [''],
      ...
      Tiles_are_laid_to_slopewithout_hollowness_Photo: [''],
      ...
      Door_color_is_consistent_Photo: [''],
      ...
      Granite_counter_is_free_of_sharp_edges_and_fixed_well_without_gaps_Photo: [''],
      ...
      Wash_Basinf: [''],
      Wash_Basinf_Photo: [''],
      Wash_Basinf_Description: [''],

      Wash_basin_faucet_is_functional: [''],
      Wash_basin_faucet_is_functional_Photo: [''],
  ...
  getGallery1() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Area_above_false_ceiling_is_painted_Photo').setValue(this.imgURL1);
      this.upload1();
    });
  }
  ...
  Save1(): void {
    ...
    console.log('ctoiletdata', JSON.stringify(this.ctoiletdata));
  }
  sendMessage1(): void {
  ...
  getGallery2() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Ceiling_tiles_are_free_of_stains_or_undulations_or_cracks_etc_Photo').setValue(this.imgURL2);
  ...
  getGallery3() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('False_ceiling_channels_are_consistent_Photo').setValue(this.imgURL3);
      ///this.ionicForm[].Electrical_wall_and_ceiling_points_are_covered_Photo=this.imgURL1;
      // this.currentImage = this.imgURL1;
  ...
  getGallery5() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Tile_Dado_urface_is_consistent_and_without_hollowness_Photo').setValue(this.imgURL5);
      this.upload5();
    });
  }
  ...
  Save5(): void {
    ...
    this.ctoiletdata.push({
      id: Date.now(),
      user: this.au.email,
      inpect_title: 'Tile_Dado_urface_is_consistent_and_without_hollowness',
      photourl: this.imgURL5,
      Description: this.ionicForm.get('Tile_Dado_urface_is_consistent_and_without_hollowness_Description').value,
      timestamp: new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' })
    });
  ...
  sendMessage5(): void {
    this.newItem.user = this.au.email;
    this.newItem.inpect_title = 'Tile_Dado_urface_is_consistent_and_without_hollowness';
    //this.newItem1.photourl = this.imgURL1;
    this.newItem.Description = this.ionicForm.get('Tile_Dado_urface_is_consistent_and_without_hollowness_Description').value;
    this.newItem.timestamp = new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' });
    ...
    let email: any = {
      ...
      cc: 'sumathi@kraft-urspace.com',
      attachments: [],
      subject: 'Tile_Dado_urface_is_consistent_and_without_hollowness',
      body: [JSON.stringify(this.newItem)],
      isHtml: true
    };
  ...
  getGallery6() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Vertical_Tiles_joints_and_ceiling_support_members_are_aligned_Photo').setValue(this.imgURL6);
      this.upload6();
    });
  }
  ...
  getGallery7() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('EWC_Ledge_wall_granite_coping_is_free_of_sharp_edges_Photo').setValue(this.imgURL7);
      this.upload7();
    });
  }
  ...
  getGallery8() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Dado_top_line_is_uniform_and_consistent_Photo').setValue(this.imgURL8);
      this.upload8();
    });
  }
  ...
  getGallery10() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Service_ledge_is_painted_and_clean_Photo').setValue(this.imgURL10);
      this.upload10();
    });
  }
  ...
  getGallery11() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Tiles_are_laid_to_slopewithout_hollowness_Photo').setValue(this.imgURL11);
      this.upload11();
    });
  }
  ...
  getGallery12() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Slopes_provided_are_adequate_Photo').setValue(this.imgURL12);
      this.upload12();
    });
  }
  ...
  getGallery13() {
    ...
    this.camera.getPicture(options).then(imageData => {
      this.picdata = imageData;
      this.imgURL12 = 'data:image/jpeg;base64,' + imageData;
      this.ionicForm.get('Tile_drop_between_dry_and_wet_areas_exists_Photo').setValue(this.imgURL12);
      this.upload13();
    });
  }
  ...
  getGallery15() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Door_frame_and_shutter_doesnot_have_dent_or_scratches_or_marks_Photo').setValue(this.imgURL15);
      this.upload15();
    });
  }
  ...
  getGallery16() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Door_frame_and_shutter_shades_are_consistent_Photo').setValue(this.imgURL16);
      this.upload16();
    });
  }
  ...
  getGallery17() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Hardware_is_as_per_standard_offering_Photo').setValue(this.imgURL17);
      this.upload17();
    });
  }
  ...
  getGallery18() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Door_color_is_consistent_Photo').setValue(this.imgURL18);
      this.upload18();
    });
  }
  ...
  Save18(): void {
    ...
    this.ctoiletdata.push({
      id: Date.now(),
      user: this.au.email,
      inpect_title: 'Door_color_is_consistent',
      photourl: this.imgURL18,
      Description: this.ionicForm.get('Door_color_is_consistent_Description').value,
      timestamp: new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' })
    });
  ...
  sendMessage18(): void {
    this.newItem.user = this.au.email;
    this.newItem.inpect_title = 'Door_color_is_consistent';
    //this.newItem1.photourl = this.imgURL1;
    this.newItem.Description = this.ionicForm.get('Door_color_is_consistent_Description').value;
    this.newItem.timestamp = new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' });
    ...
    let email: any = {
      ...
      cc: 'sumathi@kraft-urspace.com',
      attachments: [],
      subject: 'Door_color_is_consistent',
      body: [JSON.stringify(this.newItem)],
      isHtml: true
    };
  ...
  getGallery19() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Lock_can_be_operated_from_both_sides_Photo').setValue(this.imgURL19);
      this.upload19();
    });
  }
  ...
  getGallery21() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('UPVC_ventilators_are_operable_Photo').setValue(this.imgURL21);
      this.upload21();
    });
  }
  ...
  getGallery22() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Gaskets_or_sealents_are_intact_Photo').setValue(this.imgURL22);
      this.upload22();
    });
  }
  ...
  getGallery23() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Electrical_points_are_as_per_standard_offering_Photo').setValue(this.imgURL23);
      this.upload23();
    });
  }
  ...
  getGallery24() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Ceiling_electrical_points_are_covered_or_capped_properly_Photo').setValue(this.imgURL24);
      this.upload24();
    });
  }
  ...
  getGallery25() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Wall_Light_points_are_covered_or_capped_properly_Photo').setValue(this.imgURL25);
      this.upload25();
    });
  }
  ...
  Save25(): void {
    ...
    this.ctoiletdata.push({
      id: Date.now(),
      user: this.au.email,
      inpect_title: 'Wall_Light_points_are_covered_or_capped_properly',
      photourl: this.imgURL25,
      Description: this.ionicForm.get('Wall_Light_points_are_covered_or_capped_properly_Description').value,
      timestamp: new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' })
    });
  ...
  sendMessage25(): void {
    this.newItem.user = this.au.email;
    this.newItem.inpect_title = 'Wall_Light_points_are_covered_or_capped_properly';
    //this.newItem1.photourl = this.imgURL1;
    this.newItem.Description = this.ionicForm.get('Wall_Light_points_are_covered_or_capped_properly_Description').value;
    this.newItem.timestamp = new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' });
    ...
    let email: any = {
      ...
      cc: 'sumathi@kraft-urspace.com',
      attachments: [],
      subject: 'Wall_Light_points_are_covered_or_capped_properly',
      body: [JSON.stringify(this.newItem)],
      isHtml: true
    };
  ...
  getGallery26() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Switches_are_operable_Photo').setValue(this.imgURL26);
      this.upload26();
    });
  }
  ...
  getGallery27() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Switches_are_operable_Photo').setValue(this.imgURL27);
      this.upload27();
    });
  }
  ...
  getGallery29() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('All_sockets_or_switches_above_false_ceiling_are_functional_Photo').setValue(this.imgURL29);
      this.upload29();
    });
  }
  ...
  getGallery30() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Granite_counter_is_free_of_sharp_edges_and_fixed_well_without_gaps_Photo').setValue(this.imgURL30);
      this.upload30();
    });
  }
  ...
  Save30(): void {
    ...
    this.ctoiletdata.push({
      id: Date.now(),
      user: this.au.email,
      inpect_title: 'Granite_counter_is_free_of_sharp_edges_and_fixed_well_without_gaps',
      photourl: this.imgURL30,
      Description: this.ionicForm.get('Granite_counter_is_free_of_sharp_edges_and_fixed_well_without_gaps_Description').value,
      timestamp: new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' })
    });
  ...
  sendMessage30(): void {
    this.newItem.user = this.au.email;
    this.newItem.inpect_title = 'Granite_counter_is_free_of_sharp_edges_and_fixed_well_without_gaps';
    //this.newItem1.photourl = this.imgURL1;
    this.newItem.Description = this.ionicForm.get('Granite_counter_is_free_of_sharp_edges_and_fixed_well_without_gaps_Description').value;
    this.newItem.timestamp = new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' });
    ...
    let email: any = {
      ...
      cc: 'sumathi@kraft-urspace.com',
      attachments: [],
      subject: 'Granite_counter_is_free_of_sharp_edges_and_fixed_well_without_gaps',
      body: [JSON.stringify(this.newItem)],
      isHtml: true
    };
  ...
  getGallery31() {
    ...
    this.camera.getPicture(options).then(imageData => {
      this.picdata = imageData;
      this.imgURL30 = 'data:image/jpeg;base64,' + imageData;
      this.ionicForm.get('Brackets_supporting_counter_is_painted_and_free_of_rust_Photo').setValue(this.imgURL30);
      this.upload31();
    });
  }
  ...
  getGallery32() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Washbasin_and_counter_edges_are_sealed_Photo').setValue(this.imgURL32);
      this.upload32();
    });
  }
  ...
  getGallery33() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Wash_basin_faucet_is_operable_Description_Photo').setValue(this.imgURL33);
      this.upload33();
    });
  }
  ...
  Save33(): void {
    ...
    this.ctoiletdata.push({
      id: Date.now(),
      user: this.au.email,
      inpect_title: 'Wash_basin_faucet_is_operable_Description',
      photourl: this.imgURL33,
      Description: this.ionicForm.get('Wash_basin_faucet_is_operable_Description_Description').value,
      timestamp: new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' })
    });
  ...
  sendMessage33(): void {
    this.newItem.user = this.au.email;
    this.newItem.inpect_title = 'Wash_basin_faucet_is_operable_Description';
    //this.newItem1.photourl = this.imgURL1;
    this.newItem.Description = this.ionicForm.get('Wash_basin_faucet_is_operable_Description_Description').value;
    this.newItem.timestamp = new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' });
    ...
    let email: any = {
      ...
      cc: 'sumathi@kraft-urspace.com',
      attachments: [],
      subject: 'Wash_basin_faucet_is_operable_Description',
      body: [JSON.stringify(this.newItem)],
      isHtml: true
    };
  ...
  getGallery34() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Floor_trap_below_cover_is_clean_Photo').setValue(this.imgURL34);
      this.upload34();
    });
  }
  ...
  getGallery35() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Floor_trap_cover_is_provided_and_is_free_of_debris_and_rust_Photo').setValue(this.imgURL35);
      this.upload35();
    });
  }
  ...
  getGallery36() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('EWC_is_fixed_with_brackets_or_seat_covers_and_is_functional_Photo').setValue(this.imgURL36);
      this.upload36();
    });
  }
  ...
  getGallery38() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Health_Faucet_is_functional_Photo').setValue(this.imgURL38);
      this.upload38();
    });
  }
  ...
  getGallery41() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Shower_head_and_divertor_are_functional_Photo').setValue(this.imgURL41);
      this.upload41();
    });
  }
  ...
  getGallery42() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Shower_head_Photo').setValue(this.imgURL43);
      this.upload42();
    });
  }
  ...
  getGallery43() {
    ...
    this.camera.getPicture(options).then(imageData => {
      this.picdata = imageData;
      this.imgURL43 = 'data:image/jpeg;base64,' + imageData;
      this.ionicForm.get('EWC_Photo').setValue(this.imgURL43);
      this.upload43();
    });
  }
  ...
  getGallery44() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Wash_Basin_Photo').setValue(this.imgURL44);
      this.upload44();
    });
  }
  ...
  Save44(): void {
    ...
    console.log('ctoiletdata', this.ionicForm.get('Wash_Basin').value);
  }
  sendMessage44(): void {
    this.newItem.user = this.au.email;
  ...
  submitForm(): void {
    ...
    this.AssetData = JSON.stringify(this.ctoiletdata);
    this.DiningData = JSON.parse(this.AssetData);
    console.log('formdata collection', this.DiningData);

    washingtonRef
      .update({
        commonToilet: arrayUnion({
          commonToilet_data: this.DiningData
        })
      })
      .then(function () {
  ...
  exportCSV() {
    this.storageService.setObject('socialdata', this.ctoiletdata);

    var csv = this.papa.unparse(this.ctoiletdata);

    if (this.platform.is('cordova')) {
      this.file.writeFile(this.file.dataDirectory, 'commonToilet.csv', csv, { replace: true }).then(
        res => {
          this.socialSharing
  ...
  Wash_basin_faucet_is_operable_Description(): void {
    let Qvalue = this.ionicForm.get('Wash_basin_faucet_is_operable_Description').value;
    console.log('Q---->', Qvalue);
    if (Qvalue === 'No') {
  ...
  /*Wash_basin_faucet_is_functional(): void {
    let Qvalue = this.ionicForm.get('Wash_basin_faucet_is_functional').value;
    console.log('Q---->', Qvalue);
    if (Qvalue === 'No') {
