...
const db =firebase.firestore();   
      ...
      Doors_and_Windows:[''],
            ...
            Electrical:[''],
              ...
              Switch_plates_are_aligned_Description:[''],
               ...
               AC_Core_cut_pipe_is_finished_flush_with_plaster_Photo: [this.imgURL9],
            ...
            Walls_and_ceiling:[''],
              ...
              Cornices_provided_are_aligned_Description:[''],
               ...
               Walls_are_free_of_cracks_or_stains_etc_Photo: [this.imgURL18],
              Walls_are_free_of_cracks_or_stains_etc_Description:[''],
               ...
               Ceilings_are_free_of_stainss_or_undulations_or_stains_etc_Photo: [this.imgURL19],
 ...
 starttimeref.update({
  ...
  sendmail(){ 
    ...
    this.storageService.getObject('livingroom form csv').then(result => {
    if (result != null) {
    console.log('livingroom form csv: '+ result);
    this.idata= result;
    }
    }).catch(e => {
    console.log('error: ', e);
...
this.stdata=this.arrayToCSV(this.arr) ;
   this.storageService.setObject('livingroom form csv', this.stdata);
...
washingtonRef.update({
  Dining:arrayUnion({
       "livingroomu": this.DiningData
      
       
     })
}).then(function() {
  console.log("livingroom data is  updated");
});
