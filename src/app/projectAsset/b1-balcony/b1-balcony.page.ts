...
@Component({
  selector: 'app-b1-balcony',
  templateUrl: './b1-balcony.page.html',
  styleUrls: ['./b1-balcony.page.scss']
})
export class B1BalconyPage implements OnInit {
  //new
  completiontime: any;
  flist: any;
  flatnumber: any;
  ...
  ngOnInit() {
    ...
    this.ionicForm = this.formBuilder.group({
      ...
      Internal_shaft_surfaces_are_cleaned_and_painted_Photo: [''],
  ...
  getGallery1() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Walls_are_free_of_cracks_or__stains_etc_Photo').setValue(this.imgURL1);
      this.upload1();
    });
  }
  ...
  save1(): void {
    ...
    console.log('b1balconydata', JSON.stringify(this.b1balconydata));
  }
  sendMessage1(): void {
  ...
  getGallery2() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Ceilings_are_free_of_stains_or_undulations_or_cracks_etc_Photo').setValue(this.imgURL2);
  ...
  getGallery3() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Drip_moulds_in_ceiling_are_consistent_Photo').setValue(this.imgURL3);
      ///this.ionicForm[].Electrical_wall_and_ceiling_points_are_covered_Photo=this.imgURL1;
      // this.currentImage = this.imgURL1;
  ...
  getGallery4() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Elevational_ledge_horizontal_surface_is_finished_or_painted_Photo').setValue(this.imgURL4);
      this.upload4();
    });
  }
  ...
  save4(): void {
    ...
    this.b1balconydata.push({
      ...
      Description: this.ionicForm.get('Elevational_ledge_horizontal_surface_is_finished_or_painted_Description').value,
      timestamp: new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' })
    });
  ...
  sendMessage4(): void {
    this.newItem.user = this.au.email;
    this.newItem.inpect_title = 'Elevational_ledge_horizontal_surface_is_finished_or_painted';
    //this.newItem1.photourl = this.imgURL1;
    this.newItem.Description = this.ionicForm.get('Elevational_ledge_horizontal_surface_is_finished_or_painted_Description').value;
    this.newItem.timestamp = new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' });
    ...
    let email: any = {
      ...
      cc: 'sumathi@kraft-urspace.com',
      attachments: [],
      subject: 'Elevational_ledge_horizontal_surface_is_finished_or_painted',
      body: [JSON.stringify(this.newItem)],
      isHtml: true
    };
  ...
  getGallery5() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Vitrified_tiles_are_uniform_free_of_cracks_and_hollowness_Photo').setValue(this.imgURL5);
      this.upload5();
    });
  }
  ...
  getGallery6() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Floor_Slopes_provided_are_adequate_Photo').setValue(this.imgURL6);
      this.upload6();
    });
  }
  ...
  getGallery7() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Skirting_finish_and_alignment_is_correct_Photo').setValue(this.imgURL7);
      this.upload7();
    });
  }
  ...
  getGallery8() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Edges_of_floor_trap_is_finished_Photo').setValue(this.imgURL8);
      this.upload8();
    });
  }
  ...
  getGallery9() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Floor_trap_below_cover_is_clean_Photo').setValue(this.imgURL9);
      this.upload9();
    });
  }
  ...
  getGallery10() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('UPVC_balcony_doors_are_operable_Photo').setValue(this.imgURL10);
      this.upload10();
    });
  }
  ...
  getGallery11() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('UPVC_balcony_doors_are_without_sharp_edges_Photo').setValue(this.imgURL11);
      this.upload11();
    });
  }
  ...
  getGallery12() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Gaskets_or_sealents_are_intact_Photo').setValue(this.imgURL12);
      this.upload12();
    });
  }
  ...
  getGallery13() {
    ...
    this.camera.getPicture(options).then(imageData => {
      this.picdata = imageData;
      this.imgURL12 = 'data:image/jpeg;base64,' + imageData;
      this.ionicForm.get('Aluminium_channel_below_balcony_door_is_cleaned_Photo').setValue(this.imgURL12);
      this.upload13();
    });
  }
  ...
  getGallery15() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Ceiling_and_wall_electrical_points_are_covered_or_capped_properly_Photo').setValue(this.imgURL15);
      this.upload15();
    });
  }
  ...
  getGallery17() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Switch_plates_are_aligned_Photo').setValue(this.imgURL17);
      this.upload17();
    });
  }
  ...
  getGallery20() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('MS_Duct_door_frames_and_wall_junctions_are_sealed_Photo').setValue(this.imgURL20);
      this.upload20();
    });
  }
  ...
  getGallery21() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('MS_Duct_doors_are_painted_on_both_sides_Photo').setValue(this.imgURL21);
      this.upload21();
    });
  }
  ...
  getGallery23() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Internal_shaft_surfaces_are_cleaned_and_painted_Photo').setValue(this.imgURL23);
      this.upload23();
    });
  }
  ...
  save23(): void {
    ...
    this.b1balconydata.push({
      ...
      Description: this.ionicForm.get('Internal_shaft_surfaces_are_cleaned_and_painted_Description').value,
      timestamp: new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' })
    });
  ...
  sendMessage23(): void {
    this.newItem.user = this.au.email;
    this.newItem.inpect_title = 'Internal_shaft_surfaces_are_cleaned_and_painted';
    //this.newItem1.photourl = this.imgURL1;
    this.newItem.Description = this.ionicForm.get('Internal_shaft_surfaces_are_cleaned_and_painted_Description').value;
    this.newItem.timestamp = new Date().toLocaleString(undefined, { timeZone: 'Asia/Kolkata' });
    ...
    let email: any = {
      ...
      cc: 'sumathi@kraft-urspace.com',
      attachments: [],
      subject: 'Internal_shaft_surfaces_are_cleaned_and_painted',
      body: [JSON.stringify(this.newItem)],
      isHtml: true
    };
  ...
  getGallery25() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('SS_pipe_railing_end_caps_are_fixed_without_gaps_Photo').setValue(this.imgURL25);
      this.upload25();
    });
  }
  ...
  getGallery26() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Glass_in_railing_is_free_of_scratches_Photo').setValue(this.imgURL26);
      this.upload26();
    });
  }
  ...
  getGallery27() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('SS_pipe_railing_is_finshed_with_smooth_edges_Photo').setValue(this.imgURL27);
      this.upload27();
    });
  }
  ...
  getGallery28() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('SS_pipe_railing_height_is_consistent_Photo').setValue(this.imgURL28);
      this.upload28();
    });
  }
  ...
  getGallery29() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Glass_railing_assembly_is_sturdy_Photo').setValue(this.imgURL29);
      this.upload29();
    });
  }
  ...
  getGallery30() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Granite_ledge_provided_is_free_of_cracks_and_sharp_edges_Photo').setValue(this.imgURL30);
      this.upload30();
    });
  }
  ...
  getGallery31() {
    ...
    this.camera.getPicture(options).then(imageData => {
      this.picdata = imageData;
      this.imgURL30 = 'data:image/jpeg;base64,' + imageData;
      this.ionicForm.get('Vertical_texture_painted_surfaces_are_free_of_undulations_Photo').setValue(this.imgURL30);
      this.upload31();
    });
  }
  ...
  submitForm(): void {
    ...
    this.AssetData = JSON.stringify(this.b1balconydata);
    this.DiningData = JSON.parse(this.AssetData);
    console.log('formdata collection', this.DiningData);

    washingtonRef
      .update({
        BedRoom1_balcony: arrayUnion({
          BedRoom1_balcony_data: this.DiningData
        })
      })
      .then(function () {
        console.log('BedRoom1_balcony is  updated');
        this.isenabled = false;
      });
  }
  exportCSV() {
    this.storageService.setObject('socialdata', this.b1balconydata);

    var csv = this.papa.unparse(this.b1balconydata);

    if (this.platform.is('cordova')) {
      this.file.writeFile(this.file.dataDirectory, 'BedRoom1_balcony.csv', csv, { replace: true }).then(
        res => {
          this.socialSharing
      ...
      a.download = 'BedRoom1_balcony.csv';
