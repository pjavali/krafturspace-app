...
const db =firebase.firestore();   
    ...
    this.ionicForm = this.formBuilder.group({
      ...
      Doors_and_windows:[''],
            ...
            Miscellaneous:[''],
              ...
              Undulations_in_paint_due_to_textured_paints_on_vertical_surfaces_Photo:  [this.imgURL15],
            ...
            Railing:[''],
               ...
               SS_pipe_railing_is_finshed_with_smooth_edges_Photo:  [this.imgURL16],
              SS_pipe_railing_is_finshed_with_smooth_edges_Description:[''],

               SS_pipe_railing_height_is_consistent:[''],
               SS_pipe_railing_height_is_consistent_Photo:  [this.imgURL17],
              ...
              Glass_in_railing_is_free_of_scratches_Description:[''],
               ...
               Glass_railing_assembly_is_sturdy_Photo:  [this.imgURL20],
              Glass_railing_assembly_is_sturdy_Description:[''],
           
            Shafts:[''],
               Internal_surfaces_is_cleaned_and_painted:['',[Validators.required]],
               Internal_surfaces_is_cleaned_and_painted_Photo:  [this.imgURL21],
 ...
 starttimeref.update({
  ...
  sendmail(){ 
    ...
    this.storageService.getObject('dbalcony form csv').then(result => {
    if (result != null) {
...
this.stdata=this.arrayToCSV(this.arr) ;
   this.storageService.setObject('dbalcony form csv', this.stdata);
...
washingtonRef.update({
  Dining:arrayUnion({
       "dbalcony": this.DiningData
      
       
     })
}).then(function() {
  console.log("dbalcony data is  updated");
});
