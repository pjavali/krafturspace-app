...
@Component({
  selector: 'app-dbalcony',
  templateUrl: './dbalcony.page.html',
  styleUrls: ['./dbalcony.page.scss']
})
export class DBalconyPage implements OnInit {
  //new
  ...
  Save1(): void {
    ...
    console.log('diningBalconydata', JSON.stringify(this.diningBalconydata));
  }
  sendMessage1(): void {
  ...
  getGallery6() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('AC_Core_cut_pipe_is_finished_Photo').setValue(this.imgURL6);
      this.upload6();
    });
  }
  ...
  getGallery7() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Ceiling_electrical_points_are_covered_or_capped_properly_Photo').setValue(this.imgURL7);
      this.upload7();
    });
  }
  ...
  getGallery9() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Wall_Light_points_are_covered_or_capped_properly_Photo').setValue(this.imgURL9);
      this.upload9();
    });
  }
  ...
  getGallery14() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Vitrified_tiles_are_uniform_and_free_of_cracks_Photo').setValue(this.imgURL14);
      this.upload14();
    });
  }
  ...
  getGallery18() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('SS_pipe_railing_is_finshed_with_smooth_edges_Photo').setValue(this.imgURL18);
      this.upload18();
    });
  }
  ...
  getGallery24() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('MS_Duct_door_frames_and_wall_junctions_are_sealed_Photo').setValue(this.imgURL24);
      this.upload24();
    });
  }
  ...
  getGallery25() {
    ...
    this.camera.getPicture(options).then(imageData => {
      ...
      this.ionicForm.get('Shaft_internals_to_be_painted_Photo').setValue(this.imgURL25);
      this.upload25();
    });
  }
  ...
  submitForm(): void {
    ...
    this.AssetData = JSON.stringify(this.diningBalconydata);
    this.DiningData = JSON.parse(this.AssetData);
    console.log('formdata collection', this.DiningData);

    washingtonRef
      .update({
        Dining_balcony: arrayUnion({
          Dining_balcony_data: this.DiningData
        })
      })
      .then(function () {
  ...
  exportCSV() {
    this.storageService.setObject('socialdata', this.diningBalconydata);

    var csv = this.papa.unparse(this.diningBalconydata);

    if (this.platform.is('cordova')) {
      this.file.writeFile(this.file.dataDirectory, 'Dining_balcony.csv', csv, { replace: true }).then(
        res => {
          this.socialSharing
