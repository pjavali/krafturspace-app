...
export class InspectionPage implements OnInit {
  ...
  constructor(private authService: AuthService, private _cdr: ChangeDetectorRef, private platform: Platform, private firebaseService: FirebaseService, public fb: FormBuilder, private toastCtrl: ToastController, private router: Router, public alertCtrl: AlertController, public navCtrl: NavController, private NavparamService: NavparamService) {
