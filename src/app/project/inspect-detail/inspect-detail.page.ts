  ...
  ngOnInit() {
    ...
    db.collection('Krafturspace1')
      ...
      .then(doc => {
        ...
        console.log('data-->', this.Foyer, this.CommonToilet, this.LivingRoom, this.Dining, this.Kitchen, this.ServantsRoom, this.MasterBedRoom, this.BedRoom1, this.BedRoom2, this.BedRoom3, this.BedRoom4);
